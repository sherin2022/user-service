...
//        List<UserDto> usersDto = createUserDtoList();
//
//        Mockito.when(userService.getUsers()).thenReturn(userDto);
//
//        mockMvc.perform(get
//                .andDo(print())
//                .andExpect(status().isOk())
//                .andExpect(jsonPath("$", Matchers.hasSize(2)))
//                .andExpect(jsonPath("$[0].customerFirstName", Matchers.is("firstTest")));
//    }
